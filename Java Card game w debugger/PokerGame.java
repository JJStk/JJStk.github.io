...
public class PokerGame {
    ...
    System.out.println("Choose your mode (Debug mode / Normal Mode):");

    Scanner GameStart = new Scanner(System.in);
    String debugInput = GameStart.nextLine();
    Debugger.setDebugMode(debugInput);
    ...
    // You should see this once you enter the code, hello! If you want to add your own statements, use 
    // Debugger.log(message:""); to add a new print statement.
    ...
    public static void startGame() {
        Debugger.log("Creating and shuffling deck."); // Making the deck is a very important step.
        Deck deck = new Deck();                               // If the deck isn't compiled or shuffled, then the rest of the game wouldn't be random or fair.
        deck.shuffle();
    
        Debugger.log("Dealing cards to hands."); // Gotta make sure the hands are recieving the items they need to play.
        Hand hand1 = new Hand();
        ...
        Debugger.log("Displaying hands."); // Gotta display the cards you play.
        displayHands(hand1, hand2, hand3);
    
        Debugger.log("Comparing hands."); // the whole point of the game was to compare the hands to each other, to see who has the best cards.
